...
public class OperationsReport extends Report {
    String reportTitle = "OperationsReport Report";
...
//            "Primary Date", "Primary Time", "EventReport Record ID", "Primary N.Sigma", "SI Result", "Cargo", "Disposition #"
    ...
    public OperationsReport(Document document, String startTime, String endTime) {
