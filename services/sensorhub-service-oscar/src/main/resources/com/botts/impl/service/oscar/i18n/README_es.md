# Manual de administración y operación de OSCAR 3.8.5
...
- un despliegue OSCAR 3.8.5 instalado y en ejecución;
...
Base del documento: comportamiento del código OSCAR 3.8.5, revisado el 2026-09-22. Si una versión posterior cambia campos o flujos, actualice conjuntamente el manual canónico en inglés y las tres traducciones.
