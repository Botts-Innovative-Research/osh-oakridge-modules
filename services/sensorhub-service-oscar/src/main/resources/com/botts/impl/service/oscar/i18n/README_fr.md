# Manuel d'administration et d'exploitation d'OSCAR 3.9.1
...
- d'un déploiement OSCAR 3.9.1 installé et démarré ;
...
Référence du document : comportement du code OSCAR 3.9.1, revu le 2026-09-24. Si une version ultérieure change les champs ou procédures, mettez à jour ensemble le manuel canonique anglais et les trois traductions.
