...
public class DataOutputInterface implements IStreamingDataInterface {
     ...
     */
    public DataOutputInterface(D5OccupancyProcessModule parentProcess, AbstractSWEIdentifiable outputDescriptor, DataEncoding encoding) throws ProcessingException
    {
