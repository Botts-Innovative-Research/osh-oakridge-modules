...
public class ExternalSwitchAlarmOutput extends AbstractSensorOutput<WADWAZ1Sensor> implements Runnable {
     ...
     */
    ExternalSwitchAlarmOutput(WADWAZ1Sensor parentSensor) {
        ...
        try {
            ...
            while (processSets) {
                ...
                if (latestRecord == null) {
                    ...
                    dataBlock = extSwitchAlarmData.createDataBlock();
                ...
                eventHandler.publish(new DataEvent(latestRecordTime, ExternalSwitchAlarmOutput.this, dataBlock));
