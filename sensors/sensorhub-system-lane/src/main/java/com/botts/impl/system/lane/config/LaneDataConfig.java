...
public class LaneDataConfig {
    ...
    @DisplayInfo(label = "Lane Process Config", desc = "Specify automatic database process setup when creating this lane")
    public LaneProcessConfig laneProcessConfig = new LaneProcessConfig();
