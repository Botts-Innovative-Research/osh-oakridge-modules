package com.botts.impl.sensor.aspect.control;
...
public class AdjudicationControl extends AbstractSensorControl<AspectSensor> {
    ...
    public AdjudicationControl(AspectSensor parentSensor) {
