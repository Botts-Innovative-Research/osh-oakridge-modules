...
public class GammaOutput extends AbstractSensorOutput<RapiscanSensor> {
    ...
    protected void init() {
        ...
        dataStruct = radHelper.createRecord()
                ...
                .addField("Gamma 1", radHelper.createGammaGrossCount())
                .addField("Gamma 2", radHelper.createGammaGrossCount())
                .addField("Gamma 3", radHelper.createGammaGrossCount())
                .addField("Gamma 4", radHelper.createGammaGrossCount())
