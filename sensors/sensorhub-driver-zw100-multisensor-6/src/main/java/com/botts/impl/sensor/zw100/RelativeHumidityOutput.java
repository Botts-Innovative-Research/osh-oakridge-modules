...
public class RelativeHumidityOutput extends AbstractSensorOutput<ZW100Sensor> implements Runnable {
    ...
    private static final Logger logger = LoggerFactory.getLogger(RelativeHumidityOutput.class);

    private DataRecord relHumData;
     ...
     */
    RelativeHumidityOutput(ZW100Sensor parentSensor) {
    ...
    void doInit() {
        ...
        GeoPosHelper relHumHelper = new GeoPosHelper();
        ...
        try {
            ...
            while (processSets) {
                ...
                if (latestRecord == null) {
                    ...
                    dataBlock = relHumData.createDataBlock();
