...
public class LuminanceOutput extends AbstractSensorOutput<ZW100Sensor>{
    ...
    private static final Logger logger = LoggerFactory.getLogger(LuminanceOutput.class);

    private DataRecord luminanceData;
     ...
     */
    LuminanceOutput(ZW100Sensor parentSensor) {
    ...
    void doInit() {
        ...
        GeoPosHelper luminanceHelper = new GeoPosHelper();
        ...
        try {
            ...
            while (processSets) {
                ...
                if (latestRecord == null) {
                    ...
                    dataBlock = luminanceData.createDataBlock();
