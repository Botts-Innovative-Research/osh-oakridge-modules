 ...
 * @since 11/15/23
 */
public class LocationOutput extends AbstractSensorOutput<WAPIRZ1Sensor> {

    private static final String SENSOR_OUTPUT_NAME = "WAPIRZ1 Location";
     ...
     */
    LocationOutput(WAPIRZ1Sensor parentSensor) {
