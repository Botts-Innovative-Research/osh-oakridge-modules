...
/**
 * Configuration settings for the {@link LB60ZSensor} driver exposed via the OpenSensorHub Admin panel.
 * <p>
 ...
 * @since date
 */
public class LB60ZConfig extends SensorConfig {
    ...
    public class LB60ZSensorDriverConfigurations extends SensorDriverConfig {
        @DisplayInfo(desc = "Node ID value")
        public int nodeID = 31;
    ...
    public LB60ZSensorDriverConfigurations lb60zSensorDriverConfigurations =
            new LB60ZSensorDriverConfigurations();
