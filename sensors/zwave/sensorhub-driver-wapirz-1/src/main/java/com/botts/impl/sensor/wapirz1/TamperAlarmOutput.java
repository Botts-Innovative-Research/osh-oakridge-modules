 ...
 * @since 11/14/23
 */
public class TamperAlarmOutput extends AbstractSensorOutput<WAPIRZ1Sensor> {

    private static final String SENSOR_OUTPUT_NAME = "WAPIRZ1 Tamper Alarm";
     ...
     */
    TamperAlarmOutput(WAPIRZ1Sensor parentSensor) {
...
//    }
    ...
    public void onNewMessage(int key, String value, int event, int v1AlarmCode, Boolean isTamperAlarm) {
