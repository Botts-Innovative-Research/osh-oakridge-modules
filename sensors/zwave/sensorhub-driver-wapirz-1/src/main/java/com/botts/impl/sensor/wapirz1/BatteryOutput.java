 ...
 * @since 11/14/23
 */
public class BatteryOutput extends AbstractSensorOutput<WAPIRZ1Sensor> {

    private static final String SENSOR_OUTPUT_NAME = "WAPIRZ1 Battery Level";
     ...
     */
    BatteryOutput(WAPIRZ1Sensor parentSensor) {
