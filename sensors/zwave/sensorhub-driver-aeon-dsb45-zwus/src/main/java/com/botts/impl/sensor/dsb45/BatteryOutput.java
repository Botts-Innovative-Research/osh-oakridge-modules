...
import org.vast.swe.helper.GeoPosHelper;
     ...
     * @since 11/14/23
     */
    public class BatteryOutput extends AbstractSensorOutput<DSB45Sensor> {

        private static final String SENSOR_OUTPUT_NAME = "DSB45 Battery Level";
         ...
         */
        BatteryOutput(DSB45Sensor parentSensor) {
