...
/**
 * Configuration settings for the {@link ZWaveSensor} driver exposed via the OpenSensorHub Admin panel.
 * <p>
...
public class Config extends SensorConfig {
    ...
    public class DRIVERNAMESensorDriverConfigurations extends SensorDriverConfig {
        @DisplayInfo(desc = "Node ID value")
        public int nodeID = 100;
    ...
    public DRIVERNAMESensorDriverConfigurations drivernameSensorDriverConfigurations =
            new DRIVERNAMESensorDriverConfigurations();
}
