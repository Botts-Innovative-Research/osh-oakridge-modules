...
/**
 * Configuration settings for the {@link ZM1601Sensor} driver exposed via the OpenSensorHub Admin panel.
 * <p>
 ...
 * @since date
 */
public class ZM1601Config extends SensorConfig {
    ...
    public class ZM1601SensorDriverConfigurations extends SensorDriverConfig {
    ...
    @DisplayInfo(label = "ZM1601 Config")
    public ZM1601SensorDriverConfigurations zm1601SensorDriverConfigurations =
            new ZM1601SensorDriverConfigurations();
}
